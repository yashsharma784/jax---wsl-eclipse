 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webservice.javapostsforlearning.arpit.org/", wsdlLocation = "http://localhost:4262/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://webservice.javapostsforlearning.arpit.org/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4262/WS/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://webservice.javapostsforlearning.arpit.org/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.javapostsforlearning.arpit.org/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
